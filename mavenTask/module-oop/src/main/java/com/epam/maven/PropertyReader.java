...
public class PropertyReader {
    ...
    public PropertyReader() {
        ...
        try {
            FileInputStream fis = new FileInputStream("module-oop/src/main/resources/site.properties");
        ...
        try {
            FileInputStream fis = new FileInputStream("module-oop/src/main/resources/parser.properties");
